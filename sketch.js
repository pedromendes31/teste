...
var caminho1=[],caminho2=[],caminho_soma=[];
var canvas
var aux=0;
var f1,f2;
var play;
...
var playing = false;
var sp1,sp2;
var k1,k2,omega1,omega2,lambda1,lambda2,phi2,phi;
...
function draw(){
  ...
  //y1=100-50*sin(f1.value()*PI*t/100)
  //y2=100-50*sin(f2.value()*PI*t/100)
  ...
  var posicao3=createVector(x,soma);
    
  caminho1.push(posicao1);
  caminho2.push(posicao2);
  caminho_soma.push(posicao3);
